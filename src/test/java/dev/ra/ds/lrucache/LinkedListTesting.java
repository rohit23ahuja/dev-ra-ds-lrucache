...
public class LinkedListTesting {
    ...
    public void givenLinkedList_checkSizePointerHead() {
        ...
        Assert.assertEquals(Integer.valueOf(7), linkedList.getPointer()
                .getData());
        Assert.assertEquals(Integer.valueOf(3), linkedList.getHead()
                .getData());
    }
    ...
    public void givenLinkedListOfStrings_checkSizePointerHead() {
        ...
        Assert.assertEquals("deepika", linkedList.getHead()
                .getData());
        Assert.assertEquals("mummy", linkedList.getPointer()
                .getData());
    }
    ...
    public void performedMultipleOperationsOnList_checkSizeAndItems() {
        ...
        Assert.assertEquals(Integer.valueOf(7), linkedList.getPointer()
                .getData());
        Assert.assertEquals(Integer.valueOf(3), linkedList.getPointer()
                .getPrevious()
                .getData());
    }
}
